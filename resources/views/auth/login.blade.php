                        ...
                        <div>
                            ...
                            <div x-data="{ showPassword: false }" class="relative w-full">
                                <input id="password" :type="showPassword ? 'text' : 'password'" name="password" required
                                    class="w-full h-12 pl-4 pr-12 rounded-xl bg-slate-950 border border-slate-800 text-white focus:outline-none focus:border-amber-500 transition">
                                ...
                                <button type="button" @click="showPassword = !showPassword"
                                    ...
                                    <!-- Ícone do Olho Aberto (Senha Visível) -->
                                    ...
                                    <!-- Ícone do Olho Fechado (Senha Oculta) -->
                                    <svg x-show="!showPassword" class="w-5 h-5" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
