    ...
    <div class="max-w-7xl mx-auto space-y-8 animate-fade-in pb-12">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div
                ...
                <div
                    class="h-48 flex items-end justify-around gap-4 px-2 border-b border-slate-100 pb-2">
                    @php
                        // Massa de dados simulada para o MVP
                        $cyclesPerformance = [
            ...
            <div
                ...
                <div>
                    <h3
                        class="font-classic text-md font-bold text-navy-900 uppercase tracking-wider mb-2">
                ...
                <div class="grid grid-cols-2 gap-2 text-[11px] mt-4 pt-4 border-t border-slate-50">
                    <div class="flex items-center gap-2"><span class="w-2.5 h-2.5 rounded bg-navy-900 inline-block"></span>
                        <span class="text-slate-500">A: 35%</span>
                    </div>
                    <div class="flex items-center gap-2"><span class="w-2.5 h-2.5 rounded bg-gold-500 inline-block"></span>
                        <span class="text-slate-500">B: 45%</span>
                    </div>
                    <div class="flex items-center gap-2"><span class="w-2.5 h-2.5 rounded bg-slate-600 inline-block"></span>
                        <span class="text-slate-500">C: 14%</span>
                    </div>
                    <div class="flex items-center gap-2"><span class="w-2.5 h-2.5 rounded bg-slate-300 inline-block"></span>
            ...
            <div
                ...
                <div class="space-y-3">
                    @php
                        // Massa de dados simulada para o MVP substituindo as virtudes por indicadores práticos de rotina escolar
                        $engagementMetrics = [
                            ['name' => 'Pontualidade', 'status' => 'Excelente', 'trend' => 'up', 'percentage' => 92],
                            [
                            ...
                            ['name' => 'Participação em Aula', 'status' => 'Bom', 'trend' => 'up', 'percentage' => 84],
                            [
        ...
        <div
            ...
            <div class="hidden md:block overflow-x-auto">
                <table class="w-full border-collapse">
                    <thead
                        class="bg-slate-50 text-[10px] uppercase font-black text-slate-400 tracking-widest">
                        <tr>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse ($recentGrades as $grade)
                            <tr class="hover:bg-slate-50/60 transition duration-150">
                                ...
                                <td
                                    class="px-6 py-4 text-center font-mono font-black text-md text-navy-900">
