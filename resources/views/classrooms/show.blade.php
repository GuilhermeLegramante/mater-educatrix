        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden backdrop-blur-sm">
                    ...
                    <!-- Wrapper com scroll lateral ativado para mobile -->
                            ...
                            <tbody class="divide-y divide-slate-50">
                                @foreach ($classroom->students as $student)
                                    ...
                                    <tr class="hover:bg-slate-50/50 transition-colors group">
                                        ...
                                        <td class="px-6 py-4">
                                            <span
                                                class="font-bold text-navy-900 group-hover:text-gold-500 transition-colors whitespace-nowrap">
                                                {{ $student->name }}
                                            </span>
                                    ...
                                    <tr id="grades-row-{{ $student->id }}"
                                        ...
                                        <td colspan="4" class="px-6 py-4">
                                            <div
                                                class="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-3 min-w-[500px]">
                                                <div
                                                    ...
                                                    <h4
                                                        ...
                                                        <svg class="w-4 h-4 text-gold-500" fill="none"
                                                            stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
                                                                d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                        </svg>
                                                        Resumo de Conceitos • {{ $settings?->active_bimester ?? 1 }}º
                                                        Bimestre
                                                    </h4>
                                                </div>
