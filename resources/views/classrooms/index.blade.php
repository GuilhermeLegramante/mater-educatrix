...
@section('content')
            ...
            @foreach ($classrooms as $classroom)
                <a href="{{ route('classrooms.show', $classroom) }}"
                    ...
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <svg class="w-5 h-5 text-slate-300 group-hover:text-gold-500 transition-colors"
                    ...
                    <h3
                        class="font-classic text-2xl text-navy-900 mb-2 group-hover:text-gold-500 transition-colors">
                        {{ $classroom->name }}
                    </h3>
    ...
    <div id="modal-turma" onclick="if(event.target === this) closeModal('modal-turma')"
        ...
        <div class="bg-white rounded-3xl w-full max-w-md shadow-2xl border border-slate-200 overflow-hidden transform transition-all scale-95 opacity-0"
            ...
            <div
                class="p-8 bg-navy-900 text-white flex justify-between items-center border-b">
                <div>
            ...
            <form action="{{ route('classrooms.store') }}" method="POST" class="p-8 space-y-5">
                ...
                <div>
                    <label
                        class="text-[10px] font-black uppercase text-slate-400 mb-2 block tracking-wider">Nome
                        da Turma</label>
                ...
                <div>
                    <label
                        class="text-[10px] font-black uppercase text-slate-400 mb-2 block tracking-wider">Grade
                    ...
                    <div
                        ...
                        @foreach ($allSubjects as $subject)
                            <label
                                ...
                                <span
                                    class="text-xs font-bold text-navy-900">{{ $subject->name }}</span>
                            </label>
                        @endforeach
                    </div>
                </div>
                ...
                <div>
                    <label
                        class="text-[10px] font-black uppercase text-slate-400 mb-2 block tracking-wider">Ano
                        Letivo</label>
